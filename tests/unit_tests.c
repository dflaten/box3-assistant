...
static bool test_command_text_labels_builtin_and_hue_commands(void)
{
    ...
    ASSERT_TRUE(strcmp(assistant_command_text(hue_group_command_id(ASSISTANT_CMD_GROUP_BASE, 0, true),
                                              groups,
                                              2,
                                              text,
                                              sizeof(text)),
                       "Turn on kitchen") == 0);
    ASSERT_TRUE(strcmp(assistant_command_text(hue_group_command_id(ASSISTANT_CMD_GROUP_BASE, 1, false),
                                              groups,
                                              2,
                                              text,
                                              sizeof(text)),
...
int main(void)
{
    ...
    run_test("command_dispatch_resolves_builtin_and_hue_actions", test_command_dispatch_resolves_builtin_and_hue_actions);
