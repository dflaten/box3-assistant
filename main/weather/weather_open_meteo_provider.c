 ...
 */
static esp_err_t weather_open_meteo_fetch_forecast(weather_forecast_day_t day, weather_report_t *out_report) {
    if (out_report == NULL) {
        return ESP_ERR_INVALID_ARG;
    }
...
static esp_err_t weather_open_meteo_cancel_active_request(void) {
...
static const weather_provider_t s_weather_open_meteo_provider = {
    .name = "Open-Meteo",
    .fetch_forecast = weather_open_meteo_fetch_forecast,
    .cancel_active_request = weather_open_meteo_cancel_active_request,
};

const weather_provider_t *weather_open_meteo_provider_get(void) {
    return &s_weather_open_meteo_provider;
}
